...
onready var playera = load("res://Assets/RopaMapache/" + PlayerVariables.owned[0])
onready var sombrero = load("res://Assets/RopaMapache/" + PlayerVariables.owned[1])
onready var accesorio = load("res://Assets/RopaMapache/" + PlayerVariables.owned[2])
